@if ($termino != '')
    @foreach ($pacientes as $item)
        <div class="card w-100 m-1 shadow-sm">
            <div class="card-body">
                ...
                <div class="row">
                    ...
                    <a href="{{ route('citas', ['paciente' => $item->id]) }}"
                        class="btn btn-outline-dark col-sm-6 col-md-2 m-1">Agendar cita</a>
                </div>
    ...
    @endif
@else
    <h2>Introduce un valor a buscar</h2>
@endif
